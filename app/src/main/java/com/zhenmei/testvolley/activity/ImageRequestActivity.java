...
//        mQueue.add(imageRequest);
        ...
        VolleyUtils.requestImage("http://img.pconline.com.cn/images/upload/upc/tx/wallpaper/1205/02/c0/11459868_1335958865509.jpg",
                "image",
                new VolleyInterface<Bitmap>() {
                    @Override
                    public void onMySuccessResponse(Bitmap bitmap) {
