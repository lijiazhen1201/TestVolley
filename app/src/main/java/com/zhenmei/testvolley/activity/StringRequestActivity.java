...
import com.zhenmei.testvolley.utils.VolleyInterface;
import com.zhenmei.testvolley.utils.VolleyUtils;
...
//        VolleyUtils.requestGetString("http://www.baidu.com", "baidu", this);


        Map<String, String> map = new HashMap<String, String>();
        map.put("size", "1");
        String url = "http://api.1-blog.com/biz/bizserver/xiaohua/list.do";
//        url = url + "?" + VolleyUtils.checkMap(map);
//        VolleyUtils.requestGetString(url, "joke", new VolleyInterface<String>() {
//            @Override
//            public void onMySuccessResponse(String s) {
//                tv_stringrequest.setText(s);
//            }
//
//            @Override
//            public void onMyErrorResponse(VolleyError volleyError) {
//                tv_stringrequest.setText(volleyError.toString());
//            }
//        });
//        VolleyUtils.requestPostString(url, "joke", new VolleyInterface<String>() {
//            @Override
//            public void onMySuccessResponse(String s) {
//                tv_stringrequest.setText(s);
//            }
...
//            }
//        },map);
//        VolleyUtils.requestGetJson(url, "joke", new VolleyInterface<JSONObject>() {
//            @Override
//            public void onMySuccessResponse(JSONObject jsonObject) {
//                tv_stringrequest.setText(jsonObject.toString());
//            }
//
//            @Override
//            public void onMyErrorResponse(VolleyError volleyError) {
...
//            }
//        });
        VolleyUtils.requestPostJson(url, "jokk", new VolleyInterface<JSONObject>() {
            @Override
            public void onMySuccessResponse(JSONObject jsonObject) {
                tv_stringrequest.setText(jsonObject.toString());
            }
